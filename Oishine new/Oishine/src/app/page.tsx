  ...
  const submitOrder = async () => {
    ...
    try {
      ...
      if (checkoutForm.paymentMethod === 'qris') {
        ...
        alert(paymentMessages[checkoutForm.paymentMethod])
        
        // Also show toast for better UX
        toast.success('Pesanan Berhasil!', paymentMessages[checkoutForm.paymentMethod])
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <p className="text-gray-700 mb-6 leading-relaxed text-lg">
                OISHINE! hadir sejak tahun 2020 dengan komitmen untuk menyajikan masakan Jepang 
                autentik di Indonesia. Nama "OISHINE!" (おいしいね！) berarti "Enak sekali!" dalam bahasa Jepang,
                mencerminkan dedikasi kami dalam menghadirkan cita rasa terbaik. Dengan dipandu oleh chef 
                berpengalaman dari Jepang, kami menghadirkan pengalaman kuliner yang tak terlupakan 
                dengan sentuhan tradisional dan kualitas terbaik.
              </p>
              <p className="text-gray-700 mb-8 leading-relaxed text-lg">
                Setiap hidangan dibuat dengan bahan-bahan segar yang diimpor langsung dari Jepang, 
                memastikan citarasa yang otentik dan kualitas yang terjamin. Dari sushi hingga ramen, 
                setiap suapan adalah perjalanan ke Jepang.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li className="hover:text-white transition-colors interactive-cursor">Sushi & Sashimi</li>
                <li className="hover:text-white transition-colors interactive-cursor">Ramen</li>
                <li className="hover:text-white transition-colors interactive-cursor">Udon & Soba</li>
                <li className="hover:text-white transition-colors interactive-cursor">Minuman</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li className="hover:text-white transition-colors interactive-cursor">Catering</li>
              </ul>
            </div>
