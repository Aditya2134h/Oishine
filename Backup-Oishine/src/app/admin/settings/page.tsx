                ...
                <form onSubmit={updateStoreSettings} className="space-y-8">
                  ...
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Informasi ini akan ditampilkan di halaman utama pada bagian kontak
                    </p>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-2">
                    ...
                    <div className="mt-6">
                      <h4 className="text-md font-semibold text-gray-800 mb-3">Jam Operasional</h4>
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">Hari Kerja</label>
                          <input
                            type="text"
                            value={storeSettings.weekdayHours}
                            onChange={(e) => setStoreSettings({...storeSettings, weekdayHours: e.target.value})}
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                            placeholder="10:00 - 22:00"
                          />
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">Akhir Pekan</label>
                          <input
                            type="text"
                            value={storeSettings.weekendHours}
                            onChange={(e) => setStoreSettings({...storeSettings, weekendHours: e.target.value})}
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                            placeholder="10:00 - 23:00"
                          />
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">Hari Libur</label>
                          <input
                            type="text"
                            value={storeSettings.holidayHours}
                            onChange={(e) => setStoreSettings({...storeSettings, holidayHours: e.target.value})}
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                            placeholder="10:00 - 23:00"
                          />
                        </div>
